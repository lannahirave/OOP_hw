...
namespace WindowsFormsApp1
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.button2.Text = "Get perimeter";
			...
			this.textBox4.Size = new System.Drawing.Size(408, 188);
			...
			this.button4.Text = "Get square";
			this.button4.UseVisualStyleBackColor = true;
			this.button4.Visible = false;
			this.button4.Click += new System.EventHandler(this.button4_Click);
			// 
			// triangleBindingSource
			// 
			this.triangleBindingSource.DataSource = typeof(WindowsFormsApp1.Triangle);
			// 
			// Form1
			// 
